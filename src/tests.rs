...
fn check_16k() {
    ...
    assert_eq!(data, [31, 92, 220, 7, 115, 12, 199, 135, 25, 47, 178, 52, 237, 253, 205, 43]);
    assert_eq!(tag, [55, 47, 189, 132, 247, 165, 210, 109, 130, 8, 243, 7, 198, 135, 4, 157, 70, 77, 166, 68, 57, 225, 239, 37, 26, 94, 167, 27, 119, 161, 169, 123, 115, 5, 204, 203, 210, 165, 150, 213, 156, 142, 250, 53, 183, 67, 227, 179, 54, 172, 27, 123, 29, 22, 158, 184, 141, 203, 49, 125, 238, 162, 16, 143]);
